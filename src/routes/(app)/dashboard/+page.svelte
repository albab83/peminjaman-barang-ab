      ...
      <div class="grid gap-6 grid-cols-1 md:grid-cols-3">
        <div class="bg-white overflow-hidden shadow-md rounded-xl">
          <div class="p-5">
            ...
            <div class="mt-4">
              <a href="/barang/tambah" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
